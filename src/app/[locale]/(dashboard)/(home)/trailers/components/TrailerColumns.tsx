...
const TrailerColumns = ({ ...props }: ColumnsProps<TrailerSchema>): ColumnDef<TrailerSchema>[] => {
    const t = useTranslations();

    const { selectColumn, idColumn, ...commonColumns } = useCommonTableColumns<TrailerSchema>({
        ...props,
    });
    ...
    return [
        ...
        ...Object.values(commonColumns),
        {
            ...
            cell: ({ row }) => {
                ...
                return (
                    <ActionMenu itemId={item?.id ?? ''} editType='edit-trailer' dialogSize='5xl' />
                );
            },
        },
    ];
