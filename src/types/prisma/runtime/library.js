...
m.inverseTangent = m.atan = function () {
    ...
    return (
        t && (s = s.times(2 << (t - 1))), (w = !0), y(s, (c.precision = p), (c.rounding = d), !0)
    );
};
m.isFinite = function () {
    return !!this.d;
...
m.plus = m.add = function (e) {
    ...
    if (((e = new d(e)), !p.d || !e.d))
        return (
            !p.s || !e.s ? (e = new d(NaN)) : p.d || (e = new d(e.d || p.s === e.s ? p : NaN)), e
        );
...
function y(e, r, t, n) {
    ...
    return (
        w &&
            (e.e > f.maxE ? ((e.d = null), (e.e = NaN)) : e.e < f.minE && ((e.e = 0), (e.d = [0]))),
        e
    );
}
function xe(e, r, t) {
...
function ma(e, r, t) {
    let n = [`Unknown argument \`${e.red(r)}\`.`],
        i = Hd(r, t);
    return (
        i && n.push(`Did you mean \`${e.green(i)}\`?`), t.length > 0 && n.push(pt(e)), n.join(' ')
    );
}
function $d(e, r) {
    let t;
