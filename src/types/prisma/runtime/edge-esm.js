        ...
        if (
            ...
            if (((G = (G / S + 2) | 0), (h = 0), ue == 1)) {
                ...
                for (
                    v = (l / ($[0] + 1)) | 0,
                        v > 1 &&
                            (($ = e($, v, l)), (z = e(z, v, l)), (ue = $.length), (Et = z.length)),
                        tr = ue,
                        k = z.slice(0, ue),
                        F = k.length;
                    F < ue;
...
function vr(e) {
    let t = e.showColors ? hu : yu,
        r;
    return (
        typeof $getTemplateParameters < 'u' ? (r = $getTemplateParameters(e, t)) : (r = wu(e)),
        Eu(r, t)
    );
}
d();
...
function So(e, t, r) {
    let n = [`Unknown argument \`${e.red(t)}\`.`],
        i = Gu(t, r);
    return (
        i && n.push(`Did you mean \`${e.green(i)}\`?`), r.length > 0 && n.push(It(e)), n.join(' ')
    );
}
function _u(e, t) {
    let r;
            ...
            n === r.length
                ...
                : r[n]({
                      ...
                      query: (s, a = t) => {
                          ...
                          return (
                              (a.customDataProxyFetch = bs(o, l)), (a.args = s), hs(e, a, r, n + 1)
                          );
                      },
                  })
        );
