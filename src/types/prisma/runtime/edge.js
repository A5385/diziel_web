...
C.inverseTangent = C.atan = function () {
    ...
    return (
        r && (s = s.times(2 << (r - 1))), (_ = !0), I(s, (g.precision = h), (g.rounding = v), !0)
    );
};
C.isFinite = function () {
    return !!this.d;
        ...
        if (
            ...
            if (((G = (G / S + 2) | 0), (h = 0), ue == 1)) {
                ...
                for (
                    v = (l / ($[0] + 1)) | 0,
                        v > 1 &&
                            (($ = e($, v, l)), (Y = e(Y, v, l)), (ue = $.length), (xt = Y.length)),
                        ir = ue,
                        k = Y.slice(0, ue),
                        F = k.length;
                    F < ue;
...
function I(e, t, r, n) {
    ...
    return (
        _ &&
            (e.e > S.maxE ? ((e.d = null), (e.e = NaN)) : e.e < S.minE && ((e.e = 0), (e.d = [0]))),
        e
    );
}
function ge(e, t, r) {
...
function Tr(e) {
    let t = e.showColors ? Cu : Au,
        r;
    return (
        typeof $getTemplateParameters < 'u' ? (r = $getTemplateParameters(e, t)) : (r = Ru(e)),
        Su(r, t)
    );
}
d();
...
function Do(e, t, r) {
    let n = [`Unknown argument \`${e.red(t)}\`.`],
        i = Xu(t, r);
    return (
        i && n.push(`Did you mean \`${e.green(i)}\`?`), r.length > 0 && n.push(_t(e)), n.join(' ')
    );
}
function Vu(e, t) {
    let r;
            ...
            n === r.length
                ...
                : r[n]({
                      ...
                      query: (s, a = t) => {
                          ...
                          return (
                              (a.customDataProxyFetch = Rs(o, l)), (a.args = s), vs(e, a, r, n + 1)
                          );
                      },
                  })
        );
