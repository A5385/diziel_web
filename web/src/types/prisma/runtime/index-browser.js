...
h.inverseTangent = h.atan = function () {
    ...
    return (
        i && (o = o.times(2 << (i - 1))), (w = !0), p(o, (l.precision = a), (l.rounding = d), !0)
    );
};
h.isFinite = function () {
    return !!this.d;
...
h.plus = h.add = function (e) {
    ...
    if (((e = new d(e)), !a.d || !e.d))
        return (
            !a.s || !e.s ? (e = new d(NaN)) : a.d || (e = new d(e.d || a.s === e.s ? a : NaN)), e
        );
        ...
        if (
            ...
            if (((I = (I / g + 2) | 0), (a = 0), T == 1)) {
                ...
                for (
                    d = (c / (S[0] + 1)) | 0,
                        d > 1 &&
                            ((S = e(S, d, c)), (O = e(O, d, c)), (T = S.length), (W = O.length)),
                        z = T,
                        E = O.slice(0, T),
                        P = E.length;
                    P < T;
...
function p(e, n, i, t) {
                    ...
                    : c > 5 ||
                      (c == 5 &&
                          (i == 4 ||
                              t ||
                              (i == 6 &&
                                  (s > 0 ? (o > 0 ? l / C(10, r - o) : 0) : a[d - 1]) % 10 & 1) ||
                              i == (e.s < 0 ? 8 : 7)))),
            n < 1 || !a[0])
        )
            return (
    ...
    return (
        w &&
            (e.e > g.maxE ? ((e.d = null), (e.e = NaN)) : e.e < g.minE && ((e.e = 0), (e.d = [0]))),
        e
    );
}
function L(e, n, i) {
