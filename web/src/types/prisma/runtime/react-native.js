...
S.inverseTangent = S.atan = function () {
    ...
    return (
        r && (s = s.times(2 << (r - 1))), (_ = !0), O(s, (g.precision = h), (g.rounding = v), !0)
    );
};
S.isFinite = function () {
    return !!this.d;
...
S.plus = S.add = function (e) {
    ...
    if (((e = new v(e)), !h.d || !e.d))
        return (
            !h.s || !e.s ? (e = new v(NaN)) : h.d || (e = new v(e.d || h.s === e.s ? h : NaN)), e
        );
        ...
        if (
            ...
            if (((B = (B / R + 2) | 0), (h = 0), Z == 1)) {
                ...
                for (
                    v = (l / ($[0] + 1)) | 0,
                        v > 1 &&
                            (($ = e($, v, l)), (X = e(X, v, l)), (Z = $.length), (ne = X.length)),
                        Q = Z,
                        k = X.slice(0, Z),
                        D = k.length;
                    D < Z;
...
function O(e, t, r, n) {
                    ...
                    : l > 5 ||
                      (l == 5 &&
                          (r == 4 ||
                              n ||
                              (r == 6 &&
                                  (o > 0 ? (s > 0 ? g / J(10, i - s) : 0) : h[v - 1]) % 10 & 1) ||
                              r == (e.s < 0 ? 8 : 7)))),
            t < 1 || !h[0])
        )
            return (
    ...
    return (
        _ &&
            (e.e > R.maxE ? ((e.d = null), (e.e = NaN)) : e.e < R.minE && ((e.e = 0), (e.d = [0]))),
        e
    );
}
function we(e, t, r) {
...
function Mo(e, t, r) {
    let n = [`Unknown argument \`${e.red(t)}\`.`],
        i = vc(t, r);
    return (
        i && n.push(`Did you mean \`${e.green(i)}\`?`), r.length > 0 && n.push(jt(e)), n.join(' ')
    );
}
function fc(e, t) {
    let r;
            ...
            n === r.length
                ...
                : r[n]({
                      ...
                      query: (s, a = t) => {
                          ...
                          return (
                              (a.customDataProxyFetch = Ss(o, l)), (a.args = s), vs(e, a, r, n + 1)
                          );
                      },
                  })
        );
...
function Vr({ inlineDatasources: e, overrideDatasources: t, env: r, clientVersion: n }) {
    ...
    if (i === void 0)
        throw new V('error: Missing URL environment variable, value, or override.', n);
    return i;
}
m();
c();
