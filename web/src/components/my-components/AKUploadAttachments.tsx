...
// export type AKAttachmentProps<T extends FieldValues>  ={
//     title?: string;
//     name: Path<T>;
...
// export const AKUploadAttachments =<T extends FieldValues> ({
//     control,
//     title,
//     name,
//     attachmentData,
...
//                 setValue(name, allFiles[0]); // Update the form state
//             }
//         } else {
